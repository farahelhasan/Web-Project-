...
<nav id="first"  class="navbar navbar-expand-lg">
    <div class="container-fluid">
        <a style="font-weight: bold;font-size: 24px;color: #a66570"class="navbar-brand" href="index.php">AF Sweet</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a style="font-weight: bold;font-size: 18px;color: #a66570" class="nav-link active" aria-current="page" href="Outindex.php">Home</a>
                </li>
                <li class="nav-item">
                    <a style="font-weight: bold;font-size: 18px;color: #a66570" class="nav-link" href="LogInPage.php">Log in</a>
                </li>
                <li class="nav-item">
                    <a style="font-weight: bold;font-size: 18px;color: #a66570"class="nav-link" href="SignUpPage.php">Sign up</a>
                </li>
            </ul>
        </div>
    </div>
    <form style="color: pink" class="d-flex" role="search">
        <div class="button-container">
            <div    onclick="logfunction()" class="like-button" style="margin-right: 10px;background-color: #a66570">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent1">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item">
                                    ...
                                    <th><button onclick="logfunction()" type="button"class="button" style="background-color: #cb9fa7;margin-left: 5px">Products</button></th>
                            </li>
                            <br>
                            <li class="nav-item">
...
function logfunction(){
  ...
  alert ('Pleeas log in first or if you dont have account pleese sign up'); 
  document.location.href = 'Outindex.php';
}
</script>

<div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="true" style=" max-width: 800px ; margin-top: 20px" >
...
<div id="fff" style="margin-top: 20px">
    <center>
        <form style="width: 820px ">
    <strong  style="color: white ; font-family: Great Vibes variant0, Tofu;font-size: 210%;text-shadow: 2px 2px 5px black" >Welcome message</strong><br>
        <B>
            ...
            <div class="container text-center text-md-start mt-5">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                        ...
                        <p style="color: pink;width: 350px; margin-right: 10px">
                            We are not just a bakery, we are not just bakers. In fact, we are just like you, a bunch of food lovers fascinated
                    ...
                    <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
                        ...
                        <p><a href="" style="color: pink ; font-family: 'Times New Roman';font-size: 16px;width: 150px">Trending Cakes</a></p>
